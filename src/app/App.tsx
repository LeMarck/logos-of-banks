...
function SvgIcon({ src }: { src: string }): JSX.Element {
    ...
    return <section className={'card'} style={{ background: logoData.color }}>
...
export const App = (): JSX.Element => <main className={'main'}>
